...
%Checkpoints/Connectivity of Map 1 connections [connected node
%number;distance]
...
%Roundabout Map = %Checkpoints/Connectivity of Map 2 connections [connected node
%number;distance]
...
rotation_state = zeros(size(path1,1),1);
